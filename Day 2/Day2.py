...
def isSafe(line):
    ...
    if all(item in [1,2,3,-1,-2,-3] for item in amounts) and (all(item>0 for item in amounts) or all(item<0 for item in amounts)):  return 1
    return 0
